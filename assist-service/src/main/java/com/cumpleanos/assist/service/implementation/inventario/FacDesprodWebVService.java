...
import com.cumpleanos.assist.persistence.repository.views.FacDesprodWebVRepository;
...
public class FacDesprodWebVService {

    private final FacDesprodWebVRepository repository;
