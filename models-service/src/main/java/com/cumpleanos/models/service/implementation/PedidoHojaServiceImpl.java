...
public class PedidoHojaServiceImpl extends GenericServiceImpl<PedidoHoja, PedidoHojaId> implements IPedidoHojaService {
    ...
    /**
     * Cambia el estado de la hoja cuando se finaliza cualquier metodo sea Despacho etc
     * @param id -> clave compuesta de Pedido
     * @param estado -> estado a actualizar 1,2,3
     * @return mensaje y estado true del proceso
     */
    @Override
